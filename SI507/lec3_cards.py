...
class TestCard(unittest.TestCase):
    def test_init(self):
        self.card1 = Card()
        self.assertEqual(str(self.card1.suit), "Diamonds")
        self.assertEqual(str(self.card1.rank), "2")

        self.card2 = Card(2,13)
        self.assertEqual(str(self.card2.suit), "Hearts")
        self.assertEqual(str(self.card2.rank), "King")
        self.assertEqual(str(self.card2.rank_num), "13")
